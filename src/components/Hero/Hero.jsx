...
const Hero = () => {
  ...
  return (
    <div className="flex justify-center items-center relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 dark:bg-gray-950 dark:text-white duration-200 relative">
      {/* background pattern */}
